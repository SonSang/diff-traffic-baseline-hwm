...
\end{align}
%\begin{equation}
%% w = \sqrt{2\frac{\kappa_{\max}}{m}}u
%  \int_{0}^{m/4} \cos\left(2\frac{\kappa_{\max}}{m} u^2\right)\,du = \sqrt{\frac{m}{2\kappa_{\max}}}\int_{0}^{\sqrt{\kappa_{\max}m/8}} \cos\left(w^2\right)\,dw
%\end{equation}
%\begin{align}
%  \int_{m/4}^{3m/4} \cos\left(\ldots
%    %-\kappa_{\max}\left(\frac{2u^{2}}{m}-2u\right) - \kappa_{\max}\frac{m}{4}
%  \right)\,du &= \int_{m/4}^{3m/4} \cos\left(\kappa_{\max}\left(\frac{2u^{2}}{m}-2u\right) +  \kappa_{\max}\frac{m}{4}\right)\,du\\
%  &= \int_{m/4}^{3m/4} \cos\left(\kappa_{\max}\left(\frac{2u^{2}}{m}-2u\right)\right)\cos\left(\kappa_{\max}\frac{m}{4}\right)\,du - \int_{m/4}^{3m/4} \sin\left(\kappa_{\max}\left(\frac{2u^{2}}{m}-2u\right)\right)\sin\left(\kappa_{\max}\frac{m}{4}\right)\,du\\
%  &= \cos\left(\kappa_{\max}\frac{m}{4}\right)\int_{m/4}^{3m/4} \cos\left(\kappa_{\max}\left(\frac{2u^{2}}{m}-2u\right)\right)\,du - \sin\left(\kappa_{\max}\frac{m}{4}\right)\int_{m/4}^{3m/4} \sin\left(\kappa_{\max}\left(\frac{2u^{2}}{m}-2u\right)\right)\,du
%\end{align}
%\begin{align}
%  \cos\left(\kappa_{\max}\left(\frac{2u^{2}}{m}-2u\right)\right) &= \cos\left(2\kappa_{\max}\frac{u^{2}}{m}-2\kappa_{\max}u\right)\\
%  &= \cos\left(2\kappa_{\max}\frac{u^{2}}{m}\right)\cos\left(2\kappa_{\max}u\right) + \sin\left(2\kappa_{\max}\frac{u^{2}}{m}\right)\sin\left(2\kappa_{\max}u\right)
%\end{align}
